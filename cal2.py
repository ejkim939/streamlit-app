...
print(f"Streamlit 애플리케이션 코드가 '{app_filename}' 파일로 저장되었습니다.")

# Instructions for local execution
print("\n--- 로컬에서 Streamlit 앱 실행 방법 ---")
print(f"1. 위 코드를 실행하여 '{app_filename}' 파일이 생성되었는지 확인하세요.")
print(f"2. '{app_filename}' 파일을 다운로드하세요.")
print(f"3. 로컬 환경에 Streamlit이 설치되어 있지 않다면, 터미널에서 `pip install streamlit`을 실행하여 설치하세요.")
print(f"4. 터미널에서 '{app_filename}' 파일이 있는 디렉토리로 이동하여 다음 명령을 실행하세요:")
print(f"   `streamlit run {app_filename}`")
print("5. 웹 브라우저가 열리면서 Streamlit 계산기 앱이 실행될 것입니다.")
